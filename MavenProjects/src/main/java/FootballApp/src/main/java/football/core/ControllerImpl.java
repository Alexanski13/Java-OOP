...
public class ControllerImpl implements Controller {
    ...
    public String addPlayer(String fieldName, String playerType, String playerName, String nationality, int strength) {
        ...
        boolean fieldAndPlayerAreOnArtificialTurf = fieldType.equals("ArtificialTurf") && playerType.equals("Women");
        boolean fieldAndPlayerAreOnNaturalTurf = fieldType.equals("NaturalGrass") && playerType.equals("Men");

        if (fieldAndPlayerAreOnArtificialTurf || fieldAndPlayerAreOnNaturalTurf) {
            field.addPlayer(player);
        } else {
            System.out.println(FIELD_NOT_SUITABLE);
        }
    ...
    public String calculateStrength(String fieldName) {
        ...
        int strengthSum = players.stream()
